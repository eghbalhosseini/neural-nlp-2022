...
if __name__ =='__main__':
    ...
    model = AutoModel.from_pretrained(model_configs['weight_file'], config=config, state_dict=state_dict)
    #model.from_pretrained(model_file, config=config)
    tokenizer = AutoTokenizer.from_pretrained(model_configs['tokenizer_identifier'])
