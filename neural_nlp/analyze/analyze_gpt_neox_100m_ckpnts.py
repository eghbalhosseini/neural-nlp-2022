...
def mock_get_args():
    ...
    #new_args = mock_args('gpt2-neox-pos_learned-100M-v2-ckpnt', 'Fedorenko2016v3-encoding')
    new_args = mock_args('gpt2-neox-pos_learned-100M-v2-ckpnt', 'Pereira2018-encoding')
    return new_args
